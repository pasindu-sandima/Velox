...
#define XSHUT_pin3 35           //Front Sensor  Right  
#define XSHUT_pin4 36           //Front Sensor Left

#define Sensor1_newAddress 42
#define Sensor2_newAddress 43
#define Sensor3_newAddress 44
#define Sensor4_newAddress 41
...
void tofSetup(){ /*WARNING*/
  ...
  delay(10);
  Sensor4.setAddress(Sensor2_newAddress);
...
void measure(){
  ...
  distanceL = Sensor2.readRangeContinuousMillimeters();
  distanceFR= Sensor3.readRangeContinuousMillimeters();
  distanceFL= Sensor4.readRangeContinuousMillimeters();
